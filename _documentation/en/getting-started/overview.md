...
When using the Vonage APIs your requests need to be [authenticated](/concepts/guides/authentication). Typically this is done using [Basic Authentication](/concepts/guides/authentication#basic-authentication) or [JWTs](/concepts/guides/authentication#jwts). You can generate a suitable JWT using the Vonage CLI, or our [online tool](/jwt).
