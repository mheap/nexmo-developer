...
`recording_url` | `https://api-us.nexmo.com/v1/files/eeeeeee-ffff-0123-4567-0123456789ab` | Speech recording. Included if `saveAudio` flag is set to `true` in the `input` action.
